...
//            User currentUser = authService.findByUsername(currentUsername)
...
//                currentUser.setPrenom((String) updates.get("firstName"));
//            }
//
...
//                        authService.findByPhoneNumber(formattedPhoneNumber).isPresent()) {
//                    throw new ResponseStatusException(
//                            HttpStatus.CONFLICT,
